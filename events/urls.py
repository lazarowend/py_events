...
from .views import ListEventView, DetailEventView, ListUserEventView, CreateEventView, UpdateEventView
...
urlpatterns = [
    ...
    path('events/list_user_events/', ListUserEventView.as_view(), name='list_user_event_view'),
    path('events/create_event/', CreateEventView.as_view(), name='create_event_view'),
    path('events/update_event/<slug:slug>/', UpdateEventView.as_view(), name='update_event_view')
]
